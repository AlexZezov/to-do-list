  ...
  _createClass(List, [{
    ...
    value: function _render() {
      ...
      this.data.forEach(function (item) {
        var template = "\n        <h5 class=\"list-item p-3\" data-id=\"".concat(item.id, "\">").concat(item.title, "</h5>\n      ");
...
exports.List = List;
},{"./content":"js/content.js"}],"js/form.js":[function(require,module,exports) {
"use strict";
...
console.log(input);
},{"./form":"js/form.js","./list":"js/list.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
